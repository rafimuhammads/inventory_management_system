                        ...
                        <table class="table table-striped">
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="data_barang_masuk.php" class="d-sm-inline-block btn btn-sm btn-success shadow-sm"> <i class="fa fa-refresh"></i> Refresh</a>
                          ...
                          <tbody>
                            <?php
                              ...
                              while($data = mysqli_fetch_array($query)){
                                $total_harga = $data['harga_barang'] * $data['barang_masuk'];
                            ?>
                            <tr align="center">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-12">
                                        <div class="form-group">
                                          ...
                                          <div class="col-sm-15">
                                            <input type="text" name="harga_barang" value="Rp. <?= number_format($data['harga_barang']) ?>" class="form-control" autocomplete="off" readonly>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-12">
                                      ...
                                      <div class="col-md-12">
                                        <div class="form-group">
                                          <label>Total</label>
                                          <div class="col-sm-15">
                                            <input type="text" name="total_harga" value="Rp. <?= number_format($total_harga) ?>" class="form-control" autocomplete="off" readonly>
                                          </div>
                                        </div>
                                      </div>
                                      <div class="col-md-12">
