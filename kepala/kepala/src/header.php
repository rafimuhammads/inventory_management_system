            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  <ul class="list-unstyled components">
                     ...
                     <li><a href="peramalan.php"><i class="fa fa-pencil blue1_color"></i><span>Peramalan</span></a></li>
                     <li><a href="data_peramalan.php"><i class="fa fa-history red_color"></i><span>History Peramalan</span></a></li>
                  </ul>
               </div>
            </nav>
            <!-- end sidebar -->
