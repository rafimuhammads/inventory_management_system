            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  <ul class="list-unstyled components">
                     ...
                     <li class="active">
                        <a href="#master" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-history green_color"></i> <span>Data Master</span></a>
                        <ul class="collapse list-unstyled" id="master">
                           <li><a href="data_barang.php"><span>Data Barang</span></a></li>
                           <li><a href="data_persediaan.php"><span>Data Persediaan</span></a></li>
                           <li><a href="data_barang_masuk.php"><span>Barang Masuk</span></a></li>
                           <li><a href="data_barang_keluar.php"><span>Barang Keluar</span></a></li>
                        </ul>
                     </li>
                     
                     <li><a href="peramalan.php"><i class="fa fa-pencil red_color"></i><span>Peramalan Barang Masuk</span></a></li>
                     <li><a href="pelaksanaan.php"><i class="fa fa-pencil blue1_color"></i><span>Pelaksanaan Barang Masuk</span></a></li>
                     <li><a href="data_peramalan.php"><i class="fa fa-history red_color"></i><span>Pengecekan Barang Masuk</span></a></li>
                     <li><a href="penerimaan.php"><i class="fa fa-history yellow_color"></i><span>Penerimaan Barang Masuk Vendor</span></a></li>
                  </ul>
               </div>
            </nav>
            <!-- end sidebar -->
