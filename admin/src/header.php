                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="master">
                           <li>
                              <a href="data_barang.php">> <span>Data Barang</span></a>
                           </li>
                           <li>
                              <a href="data_persediaan.php">> <span>Data Persediaan</span></a>
                           </li>
                           <li>
                              <a href="data_pengguna.php">> <span>Data Pengguna</span></a>
                           </li>
                        </ul>
                     </li>
                     <li><a href="penjualan.php"><i class="fa fa-archive red_color"></i><span>Penjualan</span></a></li>
                  </ul>
               </div>
            </nav>
            <!-- end sidebar -->
                              ...
                              <ul class="user_profile_dd">
                                 <li>
                                    ...
                                    <div class="dropdown-menu">
                                       <a class="dropdown-item" href="data_admin.php">My Profile</a>
